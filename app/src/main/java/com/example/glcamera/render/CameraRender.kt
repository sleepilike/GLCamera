package com.example.glcamera.render
...
import com.example.glcamera.const.Data
import com.example.glcamera.filter.Drawer
import com.example.glcamera.filter.FBODrawer
import com.example.glcamera.filter.base.GLFrameBuffer
import com.example.glcamera.holder.CameraPresenter
import com.example.glcamera.record.MediaRecord
...
class CameraRender(glSurfaceView: GLSurfaceView) : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        Data.ALL_CONTEXT = glSurfaceView.context
